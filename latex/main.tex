...
The Bremsstrahlung is calculated using the "BremsELoss" subroutine (line 494), which sets the BEloss variable as the lost energy in (\si{keV/cm}). It takes the same arguments as "IoniElecLoss. Again, a check ensures that the returned value is always positive (line 395). \par
