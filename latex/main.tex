...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|c|c|c|}
        ...
        RL  & flyC + 1 & SINGLE & Stores random numbers for electron flying distance calculations & None \\
...
\begin{minted}[fontsize=\tiny,mathescape=false,linenos,firstnumber=186]{quickbasic.py:QuickBASICLexer -x}
...
\begin{minted}[fontsize=\tiny,mathescape=false,linenos,firstnumber=213]{quickbasic.py:QuickBASICLexer -x}
        'scanning ===============================
...
\begin{minted}[fontsize=\tiny,mathescape=false,linenos,firstnumber=281  ]{quickbasic.py:QuickBASICLexer -x}
...
\begin{minted}[fontsize=\tiny,mathescape=false,linenos,firstnumber=306]{quickbasic.py:QuickBASICLexer -x}   
...
\begin{minted}[fontsize=\tiny,mathescape=false,linenos,firstnumber=311]{quickbasic.py:QuickBASICLexer -x}   
...
\begin{minted}[fontsize=\tiny,mathescape=false,linenos,firstnumber=314]{quickbasic.py:QuickBASICLexer -x}   
...
\begin{minted}[fontsize=\tiny,mathescape=false,linenos,firstnumber=325]{quickbasic.py:QuickBASICLexer -x}   
...
\begin{minted}[fontsize=\tiny,mathescape=false,linenos,firstnumber=335]{quickbasic.py:QuickBASICLexer -x}   
...
\begin{minted}[fontsize=\tiny,mathescape=false,linenos,firstnumber=350]{quickbasic.py:QuickBASICLexer -x}   
...
\begin{minted}[fontsize=\tiny,mathescape=false,linenos,firstnumber=361]{quickbasic.py:QuickBASICLexer -x}   
...
\begin{minted}[fontsize=\tiny,mathescape=false,linenos,firstnumber=374]{quickbasic.py:QuickBASICLexer -x}
...
The randomly generated numbers are then sorted in acending order. The following is an implementation of the bubble sort algorithm. More on the bubble osrt algorithm: \href{https://en.wikipedia.org/wiki/Bubble_sort}{Bubble Sort Wikipedia Page}

\begin{minted}[fontsize=\tiny,mathescape=false,linenos,firstnumber=383]{quickbasic.py:QuickBASICLexer -x}
...
\begin{minted}[fontsize=\tiny,mathescape=false,linenos,firstnumber=393]{quickbasic.py:QuickBASICLexer -x}
