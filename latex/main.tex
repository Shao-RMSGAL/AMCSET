...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|c|c|c|}
        ...
        fly0 & Yes & INTEGER & \textbf{Unkown} & \textbf{Unkown} \\
        fly1 & Yes & INTEGER & \textbf{Unkown} & \textbf{Unkown} \\
        flyC & No & INTEGER & \textbf{Unknown} & \textbf{Unkown} \\
        flyjudge & & & & \\
        sizeScan & & & & \\
        Resolution & & & & \\
        scandelta & & & & \\
...
opens a file as the file handle "\#1" from the directory "C:\textbackslash Users\textbackslash lshao.AUTH\textbackslash Downloads\textbackslash Mott.txt". Note that this should be changed to the relevant directory on other machines.
