...
\begin{table}[h]
    ...
    If an asterick (*) is present, that means that the purpose is not confirmed. 
\end{table}
...
\begin{minted}[fontsize=\tiny,mathescape=false,linenos,firstnumber=30]{quickbasic.py:QuickBASICLexer -x}
    RANDOMIZE TIMER / 3
